...
namespace SuryaVineforceProject.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly SuryaVineforceProjectDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = SuryaVineforceProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SuryaVineforceProjectDbContext context)
        {
            _context = context;
        }
