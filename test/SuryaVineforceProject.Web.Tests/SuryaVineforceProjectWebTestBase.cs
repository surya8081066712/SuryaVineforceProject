...
{
    public abstract class SuryaVineforceProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SuryaVineforceProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SuryaVineforceProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SuryaVineforceProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SuryaVineforceProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SuryaVineforceProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SuryaVineforceProjectDbContext, Task<T>> func)
        {
            T result;
